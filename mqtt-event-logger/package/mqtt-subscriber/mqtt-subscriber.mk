...
define MQTT_SUBSCRIBER_INSTALL_INIT_SCRIPT
	...
	$(SED) "s|%HOST%|\"$(BR2_PACKAGE_MQTT_SUBSCRIBER_HOST)\"|g"   $(TARGET_DIR)/etc/init.d/S99mqtt-subscriber
	$(SED) "s|%TOPIC%|\"$(BR2_PACKAGE_MQTT_SUBSCRIBER_TOPIC)\"|g" $(TARGET_DIR)/etc/init.d/S99mqtt-subscriber
endef
